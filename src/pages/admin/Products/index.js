...
import TableProducts from "../../../components/admin/table_products";
...
const ListProducts = {
    async render() {
        ...
        <tbody id="tbody-products" class="bg-white divide-y divide-gray-200">
             ${await TableProducts.render()}
        </tbody>
        </table>
        </div>
        </div>
