import { OrderAll } from "../../../api/orders";
...
const OrderAdmin = {
    async render() {
        ...
        <th scope="col" class="p-4 text-center text-left text-xs font-medium text-gray-500 uppercase">
        Name
        </th>
        <th scope="col" class="p-4 text-center text-left text-xs font-medium text-gray-500 uppercase">
        Email
        ...
        ${data.map((orders) => /* html */`
            ...
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900"></td>
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900"></td>
