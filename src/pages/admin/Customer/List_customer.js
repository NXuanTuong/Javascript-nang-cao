...
const ListCustomer = {
    async render() {
        ...
        ${data.map((users) => /* html */`
            ...
            <img class="h-10 w-10 object-cover rounded-full" src="${users.image}" alt="Neil Sims avatar">
            </td>
            <td>
            <div class="text-sm font-normal text-gray-500">
            <div class="text-base font-semibold text-gray-900">${users.name}</div>
            <div class="text-sm font-normal text-gray-500">${users.email}</div>
            </div>
            </td>
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">${users.address}</td>
            <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">${users.position}</td>
            ...
            <button type="button" data-modal-toggle="delete-user-modal" class="btn btn-remove text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
