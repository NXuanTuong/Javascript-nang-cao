                ...
                <div class="flex -m-4 justify-between items-center">
                    <div class="relative w-full p-32 m-h-[2%]">
                        <div class ="overflow-hidden">
                            ...
                            <div class="hover:bg-red-500 cursor-pointer delay-150 duration-200 ease-in-out font-['Josefin Sans','sans-serif'] py-4 px-7 text-white bg-[#4a4a4b] rounded-md font-lg uppercase leading-0 inline-block boder-0 relative tracking-wide">
